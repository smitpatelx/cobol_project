      ...
      *
       01 input-record.
         ...
         05 define-invoice-number redefines input-record-invoice-number.
      ...
      *change characters for data line
       ...
       77 ws-ctr-page-ctr pic 99 value 0.
       77 ws-line-count pic 99 value 0.
       77 ws-lines-per-page pic 99 value 11.
       ...
       01 ws-data-tally-line.
         05 ws-prt-valid-record-line pic x(15) value "Valid records: ".
         05 filler pic x(1).
         05 ws-prt-valid-records pic 9(3).
         05 filler pic x(4).
         05 ws-prt-valid-record-line pic x(17) value
                                     "Invalid records: ".
         05 filler pic x(1).
       ...
       01 ws-heading-line-1.
         05 filler pic x(15) value "Collobrator 1".
         05 filler pic x(10).
         05 filler pic x(15) value "Collobrator 2".
         05 filler pic x(10).

       01 ws-heading-line-2.
         05 filler pic x(15) value "Smit Patel".
         05 filler pic x(10).
         05 filler pic x(15) value "Devansh Patel".
         05 filler pic x(10).


       01 ws-record-with-error.
         05 ws-record-number-line pic x(9) value "Record  :".
      ...
      *check the store  number
           if (store-is-01 or store-is-02 or store-is-03 or store-is-04
             or store-is-05 or store-is-12) then
           else
               write error-report-line from
      ...
      *check for invoice number
           if (alpha-is-AA or alpha-is-BB or alpha-is-CC or alpha-is-DD
             or alpha-is-EE) then
               write error-report-line from
                 ws-same-invoice-XX
               add 1 to ws-error-count
      ...
      *if errors are 0, then move record to the valid data file
           if (ws-error-count = 0) then
               ...
               move ws-record-number to
                 ws-record-num-data
               move input-record to
                 ws-original-record
               write error-report-line from
                 ws-record-with-error
